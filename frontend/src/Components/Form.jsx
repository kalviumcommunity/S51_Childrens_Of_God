...
const Form = () => {
 ...
 const submitIt= (e)=>{
    e.preventDefault();
    // console.log(e)
    axios.post("http://localhost:3000/addchild",{DONORNAME:formData.DONORNAME,INSTITUTIONNAME:formData.INSTITUTIONNAME,AMOUNTGIVENBYDONOR:formData.AMOUNTGIVENBYDONOR})
